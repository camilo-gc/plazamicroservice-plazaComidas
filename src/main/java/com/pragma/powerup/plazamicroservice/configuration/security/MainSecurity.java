    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.cors().and().csrf().disable()
                .authorizeRequests(requests -> requests
                        .requestMatchers("/swagger-ui.html", "/swagger-ui/**", "/v3/api-docs/**", "/v3/**", "/restaurant/**", "/dish/**", "/order/**").permitAll()
                        ...
                        //.requestMatchers("/restaurant", "/dish/restaurant/{idRestaurant}/category/{idCategory}").hasRole("CLIENT")
